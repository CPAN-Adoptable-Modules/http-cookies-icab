...
=head1 The HTTP::Cookies::iCab module

This is the I<README> for the L<HTTP::Cookies::iCab> Perl module. You're probably 
...
To read about L<HTTP::Cookies::iCab>, look at the embedded documentation 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/HTTP-Cookies-iCab> or 
L<MetaCPAN|http://www.metacpan.org/module/HTTP::Cookies::iCab>:

=over 4

=item *	L<http://search.cpan.org/dist/HTTP-Cookies-iCab>

=item *	L<http://www.metacpan.org/module/HTTP::Cookies::iCab>
...
and install the dependencies:
	...
	% cpan HTTP::Cookies::iCab
	% cpanm HTTP::Cookies::iCab
...
=item *	L<https://github.com/briandfoy/HTTP-Cookies-iCab>

=back

If you find a problem, file a ticket in the L<issue 
tracker|https://github.com/briandfoy/HTTP-Cookies-iCab/issues>:

=over 4

=item *	L<https://github.com/briandfoy/HTTP-Cookies-iCab/issues>
